  ...
  return (
    <div className="flex flex-col items-center px-8 py-16 gap-16">
      ...
      <section className="max-w-5xl w-full grid sm:grid-cols-2 gap-6">
        ...
        <GlassCard className="p-8 flex flex-col gap-4">
          <h2 className="text-2xl font-semibold text-white/90">Our Vision</h2>
          <p className="text-white/60 leading-relaxed">
        ...
        <GlassCard className="p-8 flex flex-col gap-4">
          <h2 className="text-2xl font-semibold text-white/90">Our Values</h2>
          <p className="text-white/60 leading-relaxed">
            Innovation, quality, and attention to detail drive everything we do. We never compromise on the user experience.
          </p>
        </GlassCard>
        <GlassCard className="p-8 flex flex-col gap-4">
          <h2 className="text-2xl font-semibold text-white/90">Our Team</h2>
          <p className="text-white/60 leading-relaxed">
      ...
      <section className="max-w-3xl w-full">
        <GlassCard className="p-10 text-center">
          <h2 className="text-3xl font-semibold text-white/90 mb-4">Our Journey</h2>
      ...
      <section className="max-w-4xl w-full">
        <GlassCard className="p-8">
          <h2 className="text-2xl font-semibold text-white/90 mb-6">Team Overview</h2>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-white/[0.05] backdrop-blur-xl">
                  ...
                  <th className="text-left px-6 py-4 text-white/60 font-medium">Role</th>
                  <th className="text-left px-6 py-4 text-white/60 font-medium">Experience</th>
                </tr>
              </thead>
              <tbody>
                {[
                  ...
                  <tr key={member.name} className={i < 3 ? "border-b border-white/[0.06]" : ""}>
                    <td className="px-6 py-4 text-white/90">{member.name}</td>
                    <td className="px-6 py-4 text-white/60">{member.role}</td>
                    <td className="px-6 py-4 text-white/60">{member.exp}</td>
                  </tr>
                ))}
              </tbody>
            </table>
